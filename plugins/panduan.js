...
global.panduan = [
    ...
    },
    {
        "index": "2",
        "search": "how",
        "deskripsi": "Cara menggunakan bot adalah dengan mengetikkan command bot. List command bot ada pada menu bot. jangan lupa, untuk mengakses command harus menggunakan prefix.\nPrefix DaniBotz adalah all prefix.\nContoh penggunaan prefix dan command yang benar: *.menu*",
        "judul": "Cara menggunakan bot dan prefix"
    },
    {
        "index": "3",
        "search": "add",
        "deskripsi": "Cara menambahkan bot ke dalam group. silahkan baca pada menu sewa dengan mengetikkan *.sewa*. DaniBotz memberlakukan trial gratis 3 hari. Setelah 3 hari maka bot akan keluar dari group. ada opsi 1 minggu, 1 bulan dan 2 bulan berlangganan.",
        "judul": "Cara menambahkan bot ke group",
    },
    {
        "index": "4",
        "search": "berlangganan",
        "deskripsi": "Layanan berlangganan DaniBotz adalah dengan menyewa bot dalam jumlah waktu ke dalam group. Untukm list harga/layanan silahkan baca pada *.sewa*",
        "judul": "Berlangganan"
    },
    {
        "index": "5",
