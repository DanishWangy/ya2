    ...
    if(!args[0]) {
        conn.relayWAMessage(conn.prepareMessageFromContent(m.chat, {
            "listMessage": {
              ...
              "description": "Berikut ini adalah daftar harga DanjBotz.",
              "footerText": "Silahkan tekan tombol \"Click Here\" untuk melihat daftar harga DaniBotz.\n\nJika ada pertanyaan atau semacamnya silahkan hubungi owner.",
              ...
              "sections": [
                {
                  ...
                  "rows": [{
                    "title": `Berlangganan 1 Bulan. Rp35.000`,
                  ...
                  "rows": [{
                    "title": `Berlangganan 2 Bulan. Rp45.000`,
                  ...
                  "title": "─────「 3 」"
                    ...
                    "rows": [{
                      "title": `Menjadi users premium! Rp55.000`,
        ...
        await conn.sendButtonLoc(m.chat, await(await fetch(thumbfoto)).buffer(), `Memasukkan bot ke group selama 1 bulan *Rp35.000*\n\nPembayaran dapat melalui:\nGoPay: 6281313144291\nDana: 6281313144291\nPulsa(Tsel): 6281313144291\n\nSilahkan hubungi owner untuk mengkonfirmasi atau bertanya.`, watermark, 'Owner', '.owner', m)
    } else if (args[0] == 2) {
        await conn.sendButtonLoc(m.chat, await(await fetch(thumbfoto)).buffer(), `Memasukkan bot ke group selama 2 bulan *Rp45.000*\n\nPembayaran dapat melalui:\nGoPay: 6281313144291\nDana: 6281313144291\nPulsa(Tsel): 6281313144291\n\nSilahkan hubungi owner untuk mengkonfirmasi atau bertanya.`, watermark, 'Owner', '.owner', m)
    } else if (args[0] === 'prem') {
        await conn.sendButtonLoc(m.chat, await(await fetch(thumbfoto)).buffer(), `Menjadi user premium selama 3 bulan *Rp55.000*\n\nPembayaran dapat melalui:\nGoPay: 6281313144291\nDana: 6281313144291\nPulsa(Tsel): 6281313144291\n\nSilahkan hubungi owner untuk mengkonfirmasi atau bertanya.`, watermark, 'Owner', '.owner', m)
    } else if (args[0] === 'perm') {
