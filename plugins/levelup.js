...
let handler = async (m, { conn, usedPrefix }) => {
  let who = m.sender
  let pp = await(await fetch('https://i.ibb.co/jDvNXxp/39bbded9693c9338069fd.jpg')).buffer()
  let kai = await(await fetch('https://i.ibb.co/JtqBbMQ/4d2bca79fa5a4f2dd3d81.jpg')).buffer()
  try {
